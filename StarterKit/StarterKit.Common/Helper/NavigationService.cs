...
namespace StarterKit.Common.Helper
{
    public class NavigationService : INavigationService, IDisposable
    {
        ...
        // private CustomNavigationPage _navigation;
        ...
        /// <param name="pagekey">the key of the page set while configuring navigation service</param>
        /// <param name="parameter">any parameters required by the page constructor</param>
        /// <param name="isCustomNavigationPage">is the new page to be set as CustomNavigationPage?</param>
        public async void SetMainPage(string pagekey, object parameter, bool isCustomNavigationPage)
        {
            var page = await CreatePageInstance(pagekey, parameter);
            if (isCustomNavigationPage)
            {
        ...
        private async Task<Page> CreatePageInstance(string pageKey, object parameter)
        {
            ...
            if (_pagesByKey.ContainsKey(pageKey))
            {
                ...
                var currentPage = constructor.Invoke(parameters) as Page;
                return currentPage;
            }
            else
            {
